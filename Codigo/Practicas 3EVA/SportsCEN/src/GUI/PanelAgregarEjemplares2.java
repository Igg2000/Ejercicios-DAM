 ...
 * @author grovy
 */
public class PanelAgregarEjemplares2 extends javax.swing.JPanel {
    ...
    public PanelAgregarEjemplares2(VentanaPrincipal v, Tienda t, PersonalTienda pt, Articulo articuloElegido) {
        ...
        //si son zapatillas el combo box cogera las tallas de zapatilla
        if (articuloElegido.getTipoPrenda()==Prendas.Zapatillas)
            agregarEnumsAlComboBox(TallasZapatillas.values(),cbTalla);
        else    
            agregarEnumsAlComboBox(Tallas.values(),cbTalla);
    ...
    private void initComponents() {
        ...
        cbTalla.setBackground(new java.awt.Color(154, 219, 219));
        cbTalla.setFont(new java.awt.Font("Microsoft New Tai Lue", 1, 18)); // NOI18N
        ...
        cbColor.setBackground(new java.awt.Color(154, 219, 219));
        cbColor.setFont(new java.awt.Font("Microsoft New Tai Lue", 1, 18)); // NOI18N
        cbColor.setForeground(new java.awt.Color(0, 0, 0));
        cbColor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Blanco", "Negro", "Rojo", "Azul", "Verde", "Amarillo", "Naranja", "Gris", "Rosa", "Cian", "Magenta" }));
        jPanel6.add(cbColor);
    ...
    private void bAgregarArticuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAgregarArticuloActionPerformed
        ...
        if (articuloElegido.getTipoPrenda()==Prendas.Zapatillas){
            //guardo la talla en caso de que sean zapatillas
            for (int i = 0; i < TallasZapatillas.values().length; i++) {
                if(cbTalla.getSelectedItem()==TallasZapatillas.values()[i].name())
                   tallaZapas=TallasZapatillas.values()[i];
            }
        }else{
            //guardo la talla
            for (int i = 0; i < Tallas.values().length; i++) {
                if(cbTalla.getSelectedItem()==Tallas.values()[i].name())
                    talla=Tallas.values()[i];
            }
        }
        
        Ejemplar e;
        if (articuloElegido.getTipoPrenda()==Prendas.Zapatillas)
            e= new Ejemplar(color,tallaZapas,precio,articuloElegido);
        else
            e= new Ejemplar(color,talla,precio,articuloElegido);
        
        articuloElegido.getEjemplaresArticulo().add(e);
        
        JOptionPane.showMessageDialog(this, "Ejemplar agregado con exito");

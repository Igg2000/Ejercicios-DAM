...
public class Robot {
    ...
    public void mover() {
        ...
        moverBrazosYPiernas(); // Actualizar los ángulos de brazos y piernas
    }
    

    private void moverBrazosYPiernas() {
    ...
    public boolean estaFueraDelLimite(int width) {

 ...
 * @author grovy
 */
public class PanelEliminarClientes extends javax.swing.JPanel {
    ...
    public PanelEliminarClientes(VentanaPrincipal v, Tienda t, PersonalTienda pt) {
        this.t=t;
        this.v=v;
        this.pt=pt;
        //v.setSize(600, 600);
    ...
    private void bEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarActionPerformed
        ...
        //borra de la lista de clientes el cliente que esté en la posicion que tu hayas elegido
        t.getClientesTienda().remove(t.getClientesTienda().get(elegidoLista));
        
        //copaindo lo que he hecho al principio consigo actualizar la lista    
            String cad=pt.mostrarClientes(t.getClientesTienda());
        
            this.clientesSplit = cad.split("\n");
            lista.setListData(clientesSplit);

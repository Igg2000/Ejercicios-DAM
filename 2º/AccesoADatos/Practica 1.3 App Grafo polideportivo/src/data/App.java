...
public class App {
    ...
    public void run(){
        ...
        // Conectar nodos
        grafo.conectarNodos(zonaPesas, pistaAtletismo, 15.0);
        grafo.conectarNodos(zonaPesas, duchas, 5.0);
        grafo.conectarNodos(pistaAtletismo, piscinaOlimpica, 20.0);
        grafo.conectarNodos(piscinaOlimpica, salaYoga, 10.0);
        grafo.conectarNodos(salaYoga, campoTiroArco, 8.0);
        grafo.conectarNodos(campoTiroArco, duchas, 12.0);
        grafo.conectarNodos(campoTiroArco, pistaAtletismo, 17.0);
        grafo.conectarNodos(duchas, cafeteria, 7.0);
        grafo.conectarNodos(cafeteria, zonaPesas, 9.0);
        grafo.conectarNodos(cafeteria, salaYoga, 19.0);
        grafo.conectarNodos(cafeteria, campoTiroArco, 13.0);

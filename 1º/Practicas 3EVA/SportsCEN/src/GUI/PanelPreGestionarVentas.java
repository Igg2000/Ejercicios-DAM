 ...
 * @author grovy
 */
public class PanelPreGestionarVentas extends javax.swing.JPanel {
    ...
    private String[] clientesSplit;
    
    public PanelPreGestionarVentas(VentanaPrincipal v, Tienda t, PersonalTienda pt) {
        this.t=t;
        this.v=v;
        this.pt=pt;
        //v.setSize(600, 600);
        ...
        //lo de abajo añade a la lista los clientes
            
            String cad=pt.mostrarClientes(t.getClientesTienda());
            //como mostrar clientes te los da todos juntos separados por saltos de linea , 
            //y setlistdata nos pide un array de String con un split del salto de linea lo convertimos a array
            String[] clientesSplit = cad.split("\n");
            lista.setListData(clientesSplit);
            this.clientesSplit= clientesSplit;
    }
    ...
    private void initComponents() {
        ...
        bGestionarVentas.setFont(new java.awt.Font("Microsoft JhengHei", 1, 18)); // NOI18N
        ...
        jLabel1.setText("Elige el cliente al que quieres gestionar las ventas");
    ...
    private void bGestionarVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bGestionarVentasActionPerformed
        //se le pasa al panel de gestionar ventas el cliente elegido
        int elegidoLista=lista.getSelectedIndex();
        Cliente clienteElegido = t.getClientesTienda().get(elegidoLista);

 ...
 * @author grovy
 */
public class PanelEliminarEjemplares extends javax.swing.JPanel {
    ...
    private String[] ejemplaresLista;
    
    public PanelEliminarEjemplares(VentanaPrincipal v, Tienda t, PersonalTienda pt) {
        this.t=t;
        this.v=v;
        this.pt=pt;
        //v.setSize(600, 600);

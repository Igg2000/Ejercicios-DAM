...
void RellenarRectangulo( char Rectangulo[alto][ancho], char CarContorno, char CarRelleno)
{
	int i,j;
	...
	do
	{
		...
		fflush(stdin);
		 ...
		 switch (opcion)
		 {
			case '1': 
			{
				RellenarRectangulo(Rectangulo, CarContorno, ' ');
			...
			case '2': 
			{
				RellenarRectangulo(Rectangulo,' ', CarRelleno);
				DibujarRectangulo(Rectangulo);
				salida=1;
				break;
			}
			...
			case '3': 
			{
				RellenarRectangulo(Rectangulo,CarContorno, CarRelleno);
				DibujarRectangulo(Rectangulo);
				salida=1;
				break;
			}
